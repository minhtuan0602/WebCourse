          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="/teacher/articles"><i class="fa fa-circle-o"></i> Danh sách bài viết </a></li>
                <li><a href="/teacher/articles/create"><i class="fa fa-circle-o"></i> Thêm bài viết </a></li>
              </ul>
            </li>
          </ul>
        </section>
